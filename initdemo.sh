...
then
  ...
  execute_terraform_with_workspace 'project_argo_cd_dashboard' 'octopub_audits' 'argocd_dashboard/projects/argo_cd_dashboard/pgbackend' 'Spaces-4' '-var=project_name=Overview: Octopus Audits' '-var=project_description=This project is used to manage the deployment of the Octopub Audits service via ArgoCD.' '-var=argocd_application_development=argocd/octopub-audits-development' '-var=argocd_application_test=argocd/octopub-audits-test' '-var=argocd_application_production=argocd/octopub-audits-production' '-var=argocd_version_image=octopussamples/octopub-audit-microservice' '-var=argocd_sbom_version_image=octopussamples/octopub-audit-microservice'
